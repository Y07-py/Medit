...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Authenticator/Authenticator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BoringSSL-GRPC/openssl_grpc.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Collections/Collections.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/InterposeKit/InterposeKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MCEmojiPicker/MCEmojiPicker.framework"
