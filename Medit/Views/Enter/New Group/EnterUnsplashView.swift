                            ...
                            VStack {
                                ForEach(postView.leftPostData) { item in
                                    VStack(alignment: .leading) {
                                        EnterSDWebImageView(url: item.urls.regular, isrouteView: isrouteView, selectedImage: $selectedImage, selectedURL: $selectedURL)
